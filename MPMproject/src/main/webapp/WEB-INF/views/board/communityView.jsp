            ...
            <table border="1" bgcolor="blue" class="nttable2">
                ...
                <tr>
                    <td colspan='8' rowspan="2">
                        ...
                        <button type="submit" id="ctdelete" style="background-color: #3D56B2;color: white;">글 삭제</button>
                        <button type="submit" id="ctedit" style="background-color: #3D56B2;color: white;">글 수정</button>
                    </td>
                </tr>
